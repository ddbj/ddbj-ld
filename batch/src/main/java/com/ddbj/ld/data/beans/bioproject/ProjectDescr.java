...
public class ProjectDescr {
    ...
    private LocusTagPrefix locusTagPrefix;
    ...
    public LocusTagPrefix getLocusTagPrefix() { return locusTagPrefix; }
    @JsonProperty("LocusTagPrefix")
    public void setLocusTagPrefix(LocusTagPrefix value) { this.locusTagPrefix = value; }
