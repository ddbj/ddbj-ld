...
import com.ddbj.ld.data.beans.dra.analysis.ID;
...
public class SpotDecodeSpec {
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    @JsonDeserialize(using = SpotDecodeSpec.RefSpecDeserializer.class)
    ...
    static class RefSpecDeserializer extends JsonDeserializer<List<ReadSpec>> {
        @Override
