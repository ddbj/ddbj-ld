...
@AllArgsConstructor
@Slf4j
public class DataSetAnalysisDao implements JgaDao {
    ...
    public void dropIndex() {
        this.jdbc.update("DROP INDEX idx_jga_dataset_analysis_01;");
        this.jdbc.update("DROP INDEX idx_jga_dataset_analysis_02;");
    }
}
