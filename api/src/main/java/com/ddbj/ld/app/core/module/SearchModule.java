...
import com.ddbj.ld.common.utility.api.StandardRestClient;
import com.ddbj.ld.common.utility.data.MetadataAccessor;
import com.ddbj.ld.data.json.ExcelSheetData;
import com.ddbj.ld.data.json.ListdataJson;
import com.ddbj.ld.data.json.elasticsearch.ESIndexDataContainer;
import com.ddbj.ld.data.json.elasticsearch.ESProjectIndex;
import com.ddbj.ld.data.json.elasticsearch.FacetJson;
...
import com.ddbj.ld.data.json.MetadataJson;
...
public class SearchModule {
	...
	public static class MetadataExtract {
		...
		public static ExtractUnits execute( final MetadataJson metadata ) {
			...
			var dr = new MetadataAccessor.DataRowReader();
			...
			for ( ExcelSheetData sheet : metadata.sheets ) {
				...
				for ( ExcelSheetData.MetadataItems row : rows ) {
					dr.bind( row );
