                  ...
                  <img className={[s.profileAvatar, 'rounded-circle'].join(' ')} src={a5} alt="..."/>
                                ...
                                <div>
                                    <ul className={cx(s.profileContacts, 'mt-sm')}>
                                        <li><i className="fa fa-lg fa-phone fa-fw mr-2"/>
                                            <button className="btn-link"> +375 29 555-55-55</button>
                                        </li>
                                        <li><i className="fa fa-lg fa-envelope fa-fw mr-2"/>
                                            <button className="btn-link"> psmith@example.com</button>
                                        </li>
                                        <li><i className="fa fa-lg fa-map-marker fa-fw mr-2"/>
                                            <button className="btn-link"> Minsk, Belarus</button>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <Col md={7} xs={12}>
                            ...
                            <p className="text-muted">
                                I love reading people&apos;s summaries page especially those who are in the same
                                industry as me.
              ...
              <span className={s.eventAvatar}>
                <img className="rounded-circle" src={a5} alt="..."/>
                    ...
                    <section className={s.event}>
                        ...
                        <div className={s.eventBody}>
                            Check out this awesome photo I made in Italy last summer. Seems it was lost somewhere deep
                            inside
                        ...
                        <footer className={s.eventFooter}>
                            <div className="clearfix">
                                <ul className="post-links mt-sm pull-left">
                                    ...
                                    <li>
                                        <button className="btn-link"><span className="text-danger"><i
                                            className="fa fa-heart-o"/> Like</span></button>
                                    </li>
                                    <li>
                                        <button className="btn-link">Comment</button>
                                    </li>
                  ...
                  <span className="thumb-xs avatar pull-left mr-sm">
                    <img className="rounded-circle" src={a1} alt="..."/>
                                    ...
                                    <div className="comment-body">
                                        <h6 className="author fs-sm fw-semi-bold">Ignacio Abad <small>6 mins ago</small>
                                        </h6>
