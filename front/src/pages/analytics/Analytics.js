                                    ...
                                    >
                                        <p className="text-muted d-flex flex-wrap">
                                            <small className="mr-lg d-flex align-items-center">
                                                <span className="circle bg-danger text-success mr-xs"
                                                      style={{fontSize: '4px'}}>.</span>
                                                This Period
                                            </small>
                                            <small className="mr-lg d-flex align-items-center">
                                                <span className="circle bg-primary text-warning mr-xs"
                                                      style={{fontSize: '4px'}}>.</span>
                                                Last Period
                                            </small>
                                        </p>
                                        <h6 className="fs-sm text-muted">SDK</h6>
                                        <Progress color="primary" className="progress-sm"
                                ...
                                <div className="pb-xlg h-100">
                                    ...
                                    >
                                        <div className="d-flex justify-content-between mb-sm">
                                            <p className="width-150"><small>{server[1]?.pct}% <span
                                                style={{color: '#a3aeb7'}}>/</span> {server[1]?.temp}°С <span
                                                style={{color: '#a3aeb7'}}>/</span> {server[1]?.frequency} Ghz</small>
                                            </p>
                                        ...
                                        <div className="d-flex justify-content-between mb-sm">
                                            <p className="width-150"><small>{server[2]?.pct}% <span
                                                style={{color: '#a3aeb7'}}>/</span> {server[2]?.temp}°С <span
                                                style={{color: '#a3aeb7'}}>/</span> {server[2]?.frequency} Ghz</small>
                                            </p>
                                            <div style={{width: "calc(100% - 150px)"}}>
                                                <Trend
                                                    gradient={['#005792']}
                                ...
                                <Widget
                                    ...
                                    title={
                                        <h4>Notifications <span
                                            className="badge badge-pill badge-primary fw-normal pull-right mt-xs">{mock.notifications.length}</span>
                                        </h4>
                                    }
                                >
