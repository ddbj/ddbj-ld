            ...
            <small><span className="circle bg-primary text-white">
              <i className="fa fa-plus"/></span></small>
                ...
                <Nav className="map-controls" pills fill>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2012}
                                 onClick={() => this.triggerYear(2012)}>2012</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2013}
                                 onClick={() => this.triggerYear(2013)}>2013</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2014}
                                 onClick={() => this.triggerYear(2014)}>2014</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2015}
                                 onClick={() => this.triggerYear(2015)}>2015</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2016}
                                 onClick={() => this.triggerYear(2016)}>2016</NavLink>
                    </NavItem>
                    <NavItem>
                        <NavLink active={this.state.activeYear === 2017}
                                 onClick={() => this.triggerYear(2017)}>2017</NavLink>
                    </NavItem>
                </Nav>
            </div>
        );
