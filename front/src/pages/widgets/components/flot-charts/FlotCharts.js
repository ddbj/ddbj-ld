        ...
        return (<Row>
                    ...
                    >
                        <div className="chart-stats">
                            <p className="text-light fs-mini mt-xs">
                                ...
                                <span className="fw-semi-bold">Jess:</span> Seems like statically it&apos;s getting
                                impossible
                                to achieve any sort of
                                results in nearest future. The only thing we can hope for is pressing one of these two
                                buttons:
                            </p>
                        ...
                        <div className={`${s.chart}`}>
                            <HighchartsReact options={{
                                ...options, series: this.generateRandomData([{
                ...
                <Col lg={6} xs={12}>
                    <Widget
                        ...
                        <Col xs={12}>
                            <h6 className="mb-0">
                                <span className="fw-semi-bold">Budget</span>&nbsp;<Badge pill
                                                                                         color="danger">2017</Badge>
                            </h6>
                            <span className="text-light fs-mini">monthly report will be available in <button
                                className="btn-link">6 hours</button></span>
                        </Col>
                    </Row>}
                        settings close
                    >
