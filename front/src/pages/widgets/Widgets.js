            ...
            <div className="root">
                    ...
                    <Col lg={4} xs={12}>
                        <Widget refresh close bodyClass="mt-0">
                            <div className="widget-top-overflow widget-padding-md clearfix bg-info text-white">
                                <h3 className="mt-lg mb-lg">Light Blue - <span
                                    className="fw-semi-bold">Next Generation</span> Admin
                                    Dashboard
                                    Template</h3>
                ...
                <span className="thumb-lg pull-left mr mt-n-sm">
                  <img className="rounded-circle" src={peopleA4} alt="..."/>
                            ...
                            <p className="text-light fs-mini mt-lg">Lots of cool stuff is happening around you. Just
                                calm down for a
                                sec
                            ...
                            <footer className="bg-widget-transparent">
                                <ul className="post-links">
                                    ...
                                    <li>
                                        <button className="btn-link"><span className="text-danger"><i
                                            className="fa fa-heart"/> Like</span></button>
                                    </li>
                                    <li>
                  ...
                  <span className="thumb pull-left mr mt-n-sm">
                    <img className="rounded-circle" src={peopleA6} alt="..."/>
                                ...
                                <p className="text-light fs-mini m">Lots of cool stuff is happening around you. Just
                                    calm down for a
                                    sec
                                    and listen. Colors, sounds,
                                    thoughts, ideas. </p>
                            ...
                            <footer className="bg-widget-transparent">
                                <ul className="post-links no-separator">
                                    <li>
                                        <button className="btn-link"><span className="text-danger"><i
                                            className="fa fa-heart"/> 427</span></button>
                                    </li>
                                    <li>
                                        <button className="btn-link"><i className="glyphicon glyphicon-comment"/> 98
                                        </button>
                                    </li>
                                </ul>
                            </footer>
                  ...
                  <span className="thumb pull-left mr mt-n-sm">
                    <img className="rounded-circle" src={peopleA2} alt="..."/>
                                ...
                                <p className="text-light fs-mini mt-sm">Lots of cool stuff is happening around you. Just
                                    calm down for
                                    a
                                ...
                                <div className="forecast">
                                    <div className="row">
                                        ...
                                        <div className="col-3 col-md-2 p-0">
                                            ...
                                            <Skycon className="mt-1" icon="PARTLY_CLOUDY_DAY" color="white" width="28"
                                                    height="28"/>
                                        ...
                                        <div className="col-3 col-md-2 p-0">
                                            ...
                                            <Skycon className="mt-1" icon="CLEAR_DAY" color="#f0b518" width="28"
                                                    height="28"/>
                                ...
                                <Widget className="p-0 text-center">
                                    <Row className="m-0">
                                        <div className="col-5 bg-danger btlr bblr">
                                            <Skycon className="mt-3" icon="CLEAR_DAY" color="white" width="62"
                                                    height="62"/>
                            ...
                            <Col md={6} xs={12}>
                                <Widget className="p-0 text-center">
                                    <div className="row m-0">
                                        ...
                                        <div className="col-5">
                                            <Skycon className="mt-3" icon="PARTLY_CLOUDY_DAY" color="#21AE8C" width="60"
                                                    height="60"/>
                        ...
                        <Row>
                            ...
                            <Col md={6} xs={12}>
                                ...
                                >
                                    ...
                                    <Progress color="warning" className="bg-widget-transparent-lighter progress-xs"
                                              value={29}/>
                                    <div className="clearfix fs-mini mt">
                                        <span className="pull-right m-0 fw-semi-bold">LAN</span>
                                        <span className="fs-mini">6 Mb/s <i
                                            className="fa fa-caret-down"/> &nbsp; 3 Mb/s <i
                                            className="fa fa-caret-up"
                                        /></span>
                                    </div>
                                    <Progress color="danger" className="bg-widget-transparent-lighter progress-xs"
                                              value={48}/>
                                    <div className="clearfix fs-mini mt">
                                        <span className="pull-right m-0 fw-semi-bold">Access</span>
                                        <span className="fs-mini">17 Mb/s <i className="fa fa-caret-up"/> &nbsp; (+18%)</span>
                                    </div>
                                    <Progress color="success" className="bg-widget-transparent-lighter progress-xs"
                                              value={64}/>
                                </Widget>
                            </Col>
                        </Row>
                    ...
                    <Col lg={4} xs={12}>
                      ...
                      <span className="thumb">
                        <img className="rounded-circle" src={peopleA6} alt="..."/>
                                            ...
                                            <div className="message">
                                                ...
                                                <p className="body">Hey! What&apos;s up? So much time since we saw each
                                                    other there</p>
                      ...
                      <span className="thumb">
                        <img className="rounded-circle" src={avatar} alt="..."/>
                                            ...
                                            <div>
                                                ...
                                                <p className="body">True! Totally makes sense. But how do we find
                                                    that?</p>
                                                <time className="time">10 sec ago</time>
                                            </div>
                                        </li>
                      ...
                      <span className="thumb">
                        <img className="rounded-circle" src={peopleA6} alt="..."/>
                                            ...
                                            <div>
                                                <h6 className="sender">Chris Gray</h6>
                                                <p className="body">OK, but so now what? What should we do now? Not sure
                                                    actually.</p>
                                                <time className="time">10 sec ago</time>
                                            </div>
                                        </li>
                      ...
                      <span className="thumb">
                        <img className="rounded-circle" src={avatar} alt="..."/>
                                            ...
                                            <div>
                                                <h6 className="sender">John Doe</h6>
                                                <p className="body">Hey guys, didn&apos;t you notice this conversation
                                                    is sort of jubberish?</p>
                                                <time className="time">10 sec ago</time>
                                            </div>
                                        </li>
                                    </ul>
                            ...
                            <footer className="bg-widget-transparent bt">
                                <InputGroup size="sm">
                                    ...
                                    <InputGroupAddon addonType="append"><Button
                                        color="default">Send</Button></InputGroupAddon>
                                </InputGroup>
                            </footer>
                        </Widget>
                    </Col>
                            ...
                            <div className="clearfix">
                                <Slider {...settings} className={s.hideOverflow}>
                                    <div className={s.slideWrap}>
                                        ...
                                        <div>
                                            <p className={s.positionDescriptionText}>Attention to what&apos;s really
                                                important</p>
                                            <button
                                                className={`${s.positionElementBottom} btn btn-info btn-block mt`}>Order
                                                Now!
                                            </button>
                                        </div>
                                    </div>
                                    <div className={s.slideWrap}>
                                        ...
                                        <div>
                                            <p className={s.positionDescriptionText}>Attention to what&apos;s really
                                                important</p>
                                            <button
                                                className={`${s.positionElementBottom} btn btn-inverse btn-block mt`}><span
                    ...
                    <Col xl={3} lg={4} xs={12}>
                      ...
                      <span className="thumb pull-left mr">
                        <img className="rounded-circle" src={peopleA4} alt="..."/>
                                            ...
                                            <h4 className={`${s.wideName} m-0`}><span
                                                className="fw-semi-bold">Miha </span>Koshir</h4>
                        ...
                        <div className={s.flipCard}>
                            <div className={s.flipCardInner}>
                                ...
                                <div className={s.flipCardBack}>
                                    <Widget fullscreen={false} className={`widget-padding-md ${s.slideWrap}`}
                                            bodyClass="widget-body-container">
                                        <div className="text-center">
