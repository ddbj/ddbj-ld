...
import {changeMobileState, newMessageRequest} from '../../../../actions/chat';
        ...
        return (
            <div className={`d-flex flex-column chat-dialog-section`}>
                ...
                <header className={s.chatDialogHeader}>
                    ...
                    <i className={`${s.infoIcon} la la-ellipsis-v d-xl-none`}
                       onClick={() => this.props.dispatch(changeMobileState(MobileChatStates.INFO))}></i>
                </header>
                ...
                <form className={`chat-section ${s.newMessage} mb-0`} onSubmit={this.newMessage}>
                    ...
                    <Input onChange={this.handleChange} value={this.state.newMessage} name="newMessage"
