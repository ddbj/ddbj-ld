    ...
    render() {
        return (
            <div className="chat-info-section">
                <div className="d-lg-none chat-mobile-navigation"
                     onClick={() => this.props.dispatch(changeMobileState(MobileChatStates.CHAT))}>
                        ...
                        <div className="d-flex align-items-center mb-3">
                            ...
                            <ul className={`${s.avatarsRow} ml-auto`}>
                                {this.shortUsersList().map(user => (
                                    <li key={uuid()}><Avatar showStatus={false} user={user} size={35} stroke={true}/>
                                    </li>
                                ))}
                            </ul>
                        </div>
                        <footer className="d-flex align-items-center justify-content-between">
                            <h5 className={`${s.cursorStyle} text-white mb-0`}
                                onClick={this.openModal}>{this.info().users.length - 1} members</h5>
                    ...
                    <Accordion defaultActiveKey="0" onSelect={this.updateKye}>
                        <Card>
                            <Accordion.Toggle eventKey="0" className={this.state.accordion[0] ? "active" : ""}>
                                <div className={s.toggleHeader}><img src={info} alt=""/> Information<i
                                    className="la la-angle-up ml-auto"></i></div>
                            </Accordion.Toggle>
                        ...
                        <div className={`card`}>
                            <button>
                                <label htmlFor="checkbox-ios1"
                                       className={`${s.switch} ${s.toggleHeader} switch ml-auto mb-0`}>
                        ...
                        <Card>
                            <Accordion.Toggle eventKey="1" className={this.state.accordion[1] ? "active" : ""}>
                                <div className={s.toggleHeader}><img src={picture} alt=""/> Images (4)<i
                                    className="la la-angle-up ml-auto"></i></div>
                            </Accordion.Toggle>
                      ...
                      <img className="rounded-circle" src={img1} alt="..."/>
                        ...
                        <Card>
                            <Accordion.Toggle eventKey="2" className={this.state.accordion[2] ? "active" : ""}>
                                <div className={s.toggleHeader}><img src={link} alt=""/> Links (6)<i
                                    className="la la-angle-up ml-auto"></i></div>
                            </Accordion.Toggle>
                        ...
                        <Card>
                            <Accordion.Toggle eventKey="3" className={this.state.accordion[3] ? "active" : ""}>
                                <div className={s.toggleHeader}><img src={doc} alt=""/> Files (5)<i
                                    className="la la-angle-up ml-auto"></i></div>
                            </Accordion.Toggle>
