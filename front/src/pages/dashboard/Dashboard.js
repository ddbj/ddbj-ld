                ...
                <Row>
                    ...
                    <Col lg={4}>
                        ...
                        >
                            ...
                            <p>
                                <span className="circle bg-primary text-white"><i
                        ...
                        >
                            ...
                            <p>
                                <small><span className="circle bg-primary text-white"><i
                                    className="fa fa-chevron-down"/></span></small>
                    ...
                    <span className="thumb-sm float-left mr">
                      ...
                      <i className="status status-bottom bg-success"/>
                                        ...
                                        <div>
                                            ...
                                            <p className="help-block text-ellipsis m-0">Hey! What&apos;s up? So many
                                                times since we</p>
                                        </div>
                                    </button>
                                    <button className="list-group-item text-left">
                    <span className="thumb-sm float-left mr">
                      ...
                      <i className="status status-bottom bg-success"/>
                                        ...
                                        <div>
                                            ...
                                            <p className="help-block text-ellipsis m-0">Good news coming tonight. Seems
                                                they agreed to
                                                proceed</p>
                                        </div>
                                    </button>
