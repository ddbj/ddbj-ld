...
import {useEditingInfo} from "../../../../../hooks/entries/bioproject";
        ...
        <div className={s.container}>
            ...
            <div className={s.navigation}>
                <Button
                    ...
                    onClick={() => history.push(`/entries/bioproject/${uuid}/files`)}
                >
                    Metadata & Files
                </Button>
                {'　'}
                <Button
                    ...
                    onClick={() => history.push(`/entries/bioproject/${uuid}/summary`)}
                >
                    Validation Summary
                </Button>
                {'　'}
                <Button
                    ...
                    onClick={() => history.push(`/entries/bioproject/${uuid}/comment`)}
                >
                    Comment
                </Button>
            </div>
