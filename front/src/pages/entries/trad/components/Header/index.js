...
import {useEditingInfo} from "../../../../../hooks/entries/trad";
        ...
        <div className={s.container}>
            ...
            <div className={s.navigation}>
                <Button
                    ...
                    onClick={() => history.push(`/entries/trad/${uuid}/files`)}
                >
                    Metadata & Files
                </Button>
                {'　'}
                <Button
                    ...
                    onClick={() => history.push(`/entries/trad/${uuid}/summary`)}
                >
                    Validation Summary
                </Button>
                {'　'}
                <Button
                    ...
                    onClick={() => history.push(`/entries/trad/${uuid}/comment`)}
                >
                    Comment
                </Button>
            </div>
        ...
        <div className={s.container}>
            <div className={s.navigation}>
                <Button
                    ...
                    onClick={() => history.push(`/entries/trad/${uuid}/files/upload`)}
                >
                    Metadata & Files
                </Button>
                {'　'}
                <Button
                    ...
                    onClick={() => history.push(`/entries/trad/${uuid}/files/download`)}
                >
                    Validation Summary
                </Button>
            </div>
