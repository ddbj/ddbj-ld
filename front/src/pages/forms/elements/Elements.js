                            ...
                            <FormGroup>
                                <Form>
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col md={7}>
                                            <InputGroup>
                                                <InputGroupAddon addonType="prepend"><span className="input-group-text"><i
                                                    className="fa fa-user"/></span></InputGroupAddon>
                                                <Input id="prepended-input" type="test" bsSize="16"
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col md={7}>
                                            <InputGroup>
                                                <InputGroupAddon addonType="prepend"><span className="input-group-text"><i
                                                    className="fa fa-lock"/></span></InputGroupAddon>
                                                <Input
                                    ...
                                    <FormGroup row>
                                        ...
                                        <Col md={7}>
                                            <InputGroup className="input-group-transparent">
                                                ...
                                                <InputGroupAddon addonType="append"><span
                                                    className="input-group-text"><i
                                                    className="fa fa-camera"/></span></InputGroupAddon>
                                            </InputGroup>
                                        </Col>
                                    </FormGroup>
                                    ...
                                    <FormGroup row className="form-action">
                                        <Label md={4}/>
                                        <Col md={7}>
                                            <Button color="primary" type="submit" className="mr-xs">Save
                                                Changes</Button>
                                    ...
                                    <Row>
                                        <Col md={8}>
                                            ...
                                            <FormGroup>
                                                ...
                                                <span
                                                    className="help-block">Anything can be appended to the right</span>
                                            </FormGroup>
                            ...
                            <Form>
                                ...
                                <FormGroup>
                                    <InputGroup size="sm">
                                        ...
                                        <InputGroupAddon addonType="prepend">
                                            <span className="bg-danger text-white input-group-text"><i
                                                className="fa fa-code-fork"/></span>
                                        </InputGroupAddon>
                                    </InputGroup>
                                </FormGroup>
                            </Form>
                            ...
                            <Form>
                                <Row>
                                    <Col lg="4">
                                        <legend>Basic</legend>
                                        <p>
                                            Supports bootstrap brand
                                            colors: <code>.abc-radio-primary</code>, <code>.abc-radio-danger</code>
                                            etc.
                                        ...
                                        <Col xs="6">
                                            <div className="datepicker" style={{display: 'flex'}}>
                                                ...
                                                <InputGroupAddon addonType="append" onClick={() => {
                                                    ...
                                                    <span className="input-group-text"><i
                                                        className="glyphicon glyphicon-time"/></span>
                                                </InputGroupAddon>
                                            </div>
                                        </Col>
                                    </Row>
                      ...
                      <span>
                        ...
                        />
                                ...
                                <Col lg="4">
                                    ...
                                    <p>Range selector can be displayed via <strong>{"<RangeTooltip />"} </strong>tag.
                                        Price range selector:</p>
                                    <Row>
                                        <Col md={10}>
