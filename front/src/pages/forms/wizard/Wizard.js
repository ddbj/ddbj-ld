...
import {Button, Col, FormGroup, Label, Nav, NavItem, NavLink, Progress, Row,} from 'reactstrap';
import Formsy from 'formsy-react';
import Select from 'react-select';
import MaskedInput from 'react-maskedinput';
import Datetime from 'react-datetime';
import {cardTypesData, select2CountriesData, select2ShipmentData} from './data';
                                ...
                                <div className="description">
                                    <ul className="pager wizard">
                                        <li className="previous">
                                            <Button disabled={currentStep === 1} color="primary"
                                                    onClick={this.previousStep}><i
                                        ...
                                        {currentStep < count &&
                                        <li className="next">
                                            <Button color="primary" onClick={this.nextStep}>Next <i
