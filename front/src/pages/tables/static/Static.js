                        ...
                        >
                                            ...
                                            <td>
                                                <p className="mb-0">
                                                    <small>
                                                        Type:
                                                        <span
                                                            className="text-muted fw-semi-bold">&nbsp; {row.info.type}</span>
                                                    </small>
                                                </p>
                                                <p>
                                                    <small>
                                                        Dimensions:
                                                        <span
                                                            className="text-muted fw-semi-bold">&nbsp; {row.info.dimensions}</span>
                                                    </small>
                                                </p>
                                            </td>
                            ...
                            <div className="clearfix">
                                <div className="float-right">
                                    ...
                                    <UncontrolledButtonDropdown>
                                        <DropdownToggle color="inverse" className="mr-xs" size="sm"
                                                        caret>Clear</DropdownToggle>
                                        <DropdownMenu>
                ...
                <Row>
                    <Col lg={6}>
                        ...
                        >
                            ...
                            <p>Each row is highlighted. You will never lost there. Just <code>.table-striped</code> it.
                            </p>
                            ...
                            <div className="table-responsive">
                                <Table className="table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td><Badge color="gray" className="text-gray-light" pill>Unconfirmed</Badge>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>3</td>
                        ...
                        >
                            ...
                            <Table className="table-bordered table-lg mt-lg mb-0">
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Sparklines data={[14, 12, 16, 11, 17, 19, 16]}
                                                    style={{width: '35px', height: '20px'}}>
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Sparklines data={[11, 17, 19, 16, 14, 12, 16]}
                                                    style={{width: '35px', height: '20px'}}>
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Sparklines data={[13, 14, 20, 16, 15, 4, 14]}
                                                    style={{width: '35px', height: '20px'}}>
                                            <SparklinesBars style={{stroke: 'white', fill: '#005792'}}/>
                                        </Sparklines>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td className="text-center">
                                        <Sparklines data={[16, 15, 4, 14, 13, 14, 20]}
                                                    style={{width: '35px', height: '20px'}}>
