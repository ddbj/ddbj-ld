    ...
    render() {
        return (
            <div>
                ...
                <p className="lead">Over 8,000 developers worldwide chose our bootstrap admin templates to build their
                ...
                <Row>
                    <Col lg={5} md={6}>
                        ...
                        >
                            <img className={['rounded pull-left mb-1 mr-3', s.image].join(' ')} src={reactLogo}
                                 width="80" alt=""/>
                            <h3>React JS Version</h3>
                            <p className="text-muted">We spent another <span
                                className="fw-semi-bold">500</span> man-hours
                                developing and designing
                                React version, to save you time and money.</p>
                            <p><a href="https://reactjs.org/" rel="nofollow noopener noreferrer"
                                  target="_blank">React</a> is
                    ...
                    <Col lg={5} md={6} xs={12}>
                        ...
                        >
                            <img className={['rounded pull-left mb-1 mr-3', s.image].join(' ')} src={angularLogo}
                                 width="80" alt=""/>
                            <h3>Angular 2+ Version</h3>
                            <p className="text-muted">We spent around <span
                                className="fw-semi-bold">500</span> man-hours
                                developing and designing
                                Angular version, to match high engineering requirements.</p>
                            <p><a href="https://angular.io" rel="nofollow noopener noreferrer"
                                  target="_blank">Angular</a> is the
                            ...
                            <p>Our app is built on top of latest <strong>Angular 5.0</strong> version and
                                uses <a href="https://webpack.js.org/">Webpack</a> Module Bundler and NPM as a package
                                manager,
                                so everything
                    ...
                    <Col lg={5} md={6}>
                        ...
                        >
                            <img className={['rounded pull-left mb-1 mr-3', s.image].join(' ')} src={angularJSLogo}
                                 width="80" alt=""/>
                            <h3>AngularJS Version</h3>
                            <p className="text-muted">We don’t know about you but we’re very excited that it’s finally
                                here!
                                Our brand new Light Blue Angular version.</p>
                            <p><strong>Angular 1.0</strong> have so many opportunities in comparison to HTML. It lets
                                you
                                extend HTML vocabulary.
                                And as a result your application can be very expressive and readable.
                                <strong>Directives</strong> can hide complex DOM structure, CSS. They can let you invent
                                new
                                HTML syntax, specific to your application.
                                We strongly believe that there’s nothing better than arranging an outstanding end-user
                                experience.</p>
                            <p><a href="https://reactjs.org/" rel="nofollow noopener noreferrer"
                    ...
                    <Col lg={5} md={6} xs={12}>
                        ...
                        >
                            <img className={['rounded pull-left mb-1 mr-3', s.image].join(' ')} src={jsLogo} width="80"
                                 alt=""/>
                            <h3>HTML5 Version</h3>
                    ...
                    <Col lg={5} md={6}>
                        ...
                        >
                            <img className={['rounded pull-left mb-1 mr-3', s.image].join(' ')} src={vueLogo} width="80"
                                 alt=""/>
