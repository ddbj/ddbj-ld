...
import {Badge, Button, Card, CardBody, CardImg, CardText, CardTitle, Col, Row,} from 'reactstrap';
            ...
            <Col>
                ...
                >
                    <CardBody className="text-white">
                        ...
                        <p className="w-75">A lifestyle brand is a company that markets its products or services to
                            embody the
        ...
        <Row>
            ...
            <Col xs={12} sm={6} md={4}>
                ...
                <Card className="mb-xlg border-0" style={{position: 'relative'}}>
                    ...
                    <Badge className="mt-lg fw-thin rounded-0" color="success"
                           style={{position: 'absolute'}}>New</Badge>
                    <CardBody>
