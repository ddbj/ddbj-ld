                        ...
                        >
                            <div>
                                <p className="fs-mini">
                                    ...
                                    Semantically distinguishable beauty.
                                    Use <code>.btn-rounded</code> or <code>.btn-rounded-f</code>.
                                </p>
                                <p>
                                    <Button color="default"
                                            className="btn-rounded-f width-100 mb-xs mr-xs">Default</Button>
                                    <Button color="primary"
                                            className="btn-rounded-f width-100 mb-xs mr-xs">Primary</Button>
                                    <Button color="info" className="btn-rounded-f width-100 mb-xs mr-xs">Info</Button>
                                    <Button color="success"
                                            className="btn-rounded-f width-100 mb-xs mr-xs">Success</Button>
                                    <Button outline color="warning"
                                            className="btn-rounded width-100 mb-xs mr-xs">Warning</Button>
                                    <Button outline color="danger"
                                            className="btn-rounded width-100 mb-xs mr-xs">Danger</Button>
                                    <Button outline color="gray"
                                            className="btn-rounded width-100 mb-xs mr-xs">Gray</Button>
                                    <Button outline color="inverse"
                                            className="btn-rounded width-100 mb-xs mr-xs">Inverse</Button>
                                </p>
                            </div>
                        </Widget>
                    </Col>
