...
import {Button, Col, Popover, PopoverBody, PopoverHeader, Row, Tooltip,} from 'reactstrap';
    ...
    render() {
        return (
            <div>
                ...
                <Popover placement="top" isOpen={this.state.popovers[0]} target="p-1"
                ...
                <Popover placement="top" isOpen={this.state.popovers[1]} target="p-2"
                ...
                <Popover placement="top" isOpen={this.state.popovers[2]} target="p-3"
                ...
                <Popover placement="right" isOpen={this.state.popovers[3]} target="p-4"
                ...
                <Popover placement="bottom" isOpen={this.state.popovers[4]} target="p-5"
                ...
                <Popover placement="left" isOpen={this.state.popovers[5]} target="p-6"
                ...
                <Tooltip placement="top" isOpen={this.state.tooltips[0]} toggle={() => this.toggle(0, 'tooltips')}
                         target="t-1">
                    Hello world!
                </Tooltip>
                <Tooltip placement="top" isOpen={this.state.tooltips[1]} toggle={() => this.toggle(1, 'tooltips')}
                         target="t-2">
                    Hello world!
                </Tooltip>
                <Tooltip placement="top" isOpen={this.state.tooltips[2]} toggle={() => this.toggle(2, 'tooltips')}
                         target="t-3">
                    Top
                </Tooltip>
                <Tooltip placement="right" isOpen={this.state.tooltips[3]} toggle={() => this.toggle(3, 'tooltips')}
                         target="t-4">
                    Right
                </Tooltip>
                <Tooltip placement="bottom" isOpen={this.state.tooltips[4]} toggle={() => this.toggle(4, 'tooltips')}
                         target="t-5">
                    Bottom
                </Tooltip>
                <Tooltip placement="left" isOpen={this.state.tooltips[5]} toggle={() => this.toggle(5, 'tooltips')}
                         target="t-6">
                    Left
                </Tooltip>
            </div>
