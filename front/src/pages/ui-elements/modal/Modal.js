                ...
                <Row>
                    <Col xs={12} md={6}>
                        ...
                        >
                            ...
                            <Button color="primary" onClick={() => this.toggle('scrollingLong')}>Scrolling long
                                content</Button>
                        </Widget>
                        <Widget
                        ...
                        >
                            ...
                            <Button className="mr-sm" color="primary" onClick={() => this.toggle('large')}>Large
                                modal</Button>
                    ...
                    <Col xs={12} md={6}>
                        ...
                        >
                            <p>
                                Utilize the Bootstrap grid system within a modal by nesting <code>&lt;Container
                                fluid&gt;</code> within
                                the <code>&lt;ModalBody&gt;</code>. Then, use the normal grid system classes as you
                                would anywhere else.
                            </p>
                ...
                <Modal isOpen={launch} toggle={() => this.toggle('launch')}>
                    ...
                    <ModalBody className="bg-white text-white">
                        <Container fluid>
                            <Row>
                                <Col md={4}>
                                    <div className="h-100 w-100 bg-primary p-2">.col-md-4</div>
                                </Col>
                                <Col md={4} className="ml-auto">
                                    <div className="h-100 w-100 bg-primary p-2">.col-md-4 .ml-auto</div>
                                </Col>
                            </Row>
                            <Row className="mt-sm">
                                <Col md={3} className="ml-auto">
                                    <div className="h-100 w-100 bg-primary p-2">.col-md-3 .ml-auto</div>
                                </Col>
                                <Col md={4} className="ml-auto">
                                    <div className="h-100 w-100 bg-primary p-2">.col-md-4 .ml-auto</div>
                                </Col>
                            ...
                            <Row className="mt-sm">
                                <Col md={6} className="ml-auto">
                                    <div className="h-100 w-100 bg-primary p-2">.col-md-6 .ml-auto</div>
                                </Col>
                            </Row>
                        </Container>
                    </ModalBody>
