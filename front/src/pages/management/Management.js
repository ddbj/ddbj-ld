...
import {deleteProductRequest, getProductsRequest} from '../../actions/products'
        ...
        return (
            <ButtonToolbar>
                <Button color="info" size="xs"
                        onClick={() => this.props.history.push('/app/ecommerce/management/' + row.id)}>
                ...
                <Popover className="popover-danger" target={'popoverDelete_' + row.id} placement="top"
        ...
        return (
            <div>
                <div className="page-top-line">
                    ...
                    >
                        This page is only available in <a className="text-white font-weight-bold"
                                                          rel="noreferrer noopener"
                                                          href="https://flatlogic.com/admin-dashboards/sing-app-react-node-js"
                                                          target="_blank">Sing App React with Node.js</a> integration!
                    </Alert>
                </div>
