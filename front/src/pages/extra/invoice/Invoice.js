                                    ...
                                    <section className={s.invoiceBody}>
                                        <Row className="mb-lg">
                                            <Col sm={6} className="col-print-6">
                                                ...
                                                <address>
                                                    ...
                                                    088.253.5345<br/>
                                                    <abbr title="Work email">e-mail:</abbr> <a
                                                    href="mailto:#">email@example.com</a><br/>
                                            ...
                                            <Col sm={6} className="col-print-6 text-right">
                                                ...
                                                <address>
                                                    ...
                                                    {/* eslint-enable */}
                                                    <abbr title="Work email">e-mail:</abbr> <a
                                                    href="mailto:#">maryna@allspana.by</a><br/>
                                                    <abbr title="Work Phone">phone:</abbr> (012) 345-678-901<br/>
                                                    <abbr title="Work Fax">fax:</abbr> (012) 678-132-901
                                                    <p className="no-margin"><strong>Note:</strong></p>
                                                    <p className="text-muted">Some nights I stay up cashing in my bad
                                                        luck.
                                        ...
                                        <Table className="table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td className="hidden-sm-down d-print-none">2,560x1,440-pixel (WQHD)
                                            ...
                                            <tr>
                                                ...
                                                <td className="hidden-sm-down d-print-none">Novel by Ayn Rand, first
                                            ...
                                            <tr>
                                                ...
                                                <td className="hidden-sm-down d-print-none">Lyrics: praesent blandit
                                                    augue non sapien ornare
                                                    imperdiet
                                                </td>
                                                <td>1</td>
                                        ...
                                        <Row>
                                            <Col xs={12} md={8} className="col-print-6">
                                                <p>
                                                    <strong>Note:</strong>
                                                    Thank you for your business. Keep in mind, sometimes bad things
