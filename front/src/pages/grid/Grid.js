        ...
        return (
            <div>
                ...
                <Row>
                    ...
                    <Col xl={7}>
                        <Widget
                            title={<h5>Draggable Grid &nbsp;<span
                                className="badge badge-danger fw-normal">since 2.1</span></h5>}
                        >
                            <div>
                                <p>
                                    <strong>Widgster</strong> is a plugin that allows to easily implement basic widget
                                    functions that
                                    lots of our customers have requested. For now it has the following essential
                                    widget features:
                                </p>
                                <ul className="text-list">
                                    <li><strong>Collapse/Expand</strong> - all widgets can be collapsed to fill only
                                        header&apos;s
                                        vertical
                                        space;
                                    </li>
                                    <li><strong>Close</strong> - closable. Any widget may be removed by clicking the
                                        close btn;
                                    </li>
                                    <li><strong>Full Screen</strong> - an option to make widget fill the whole window
                                        (just like OS);
                                    </li>
                                ...
                                <p>It&apos;s available under MIT license, check out
                                    <a href="https://github.com/flatlogic/widgster" target="_blank"
                            ...
                            >
                                <div>
                                    ...
                                    <p className="lead text-muted text-center">
                                        Faith makes it possible to achieve that which man&apos;s mind can conceive and
                                        believe.
                                    </p>
                                    <Form>
                                        <FormGroup>
                                            <Label for="exampleInputEmail1"><i
                                                className="fa fa-circle text-warning"/> &nbsp; Email
                                                address</Label>
                                            <Input
                                        ...
                                        <p>
                                            ...
                                            set <strong>autoload</strong> attribute and provide an api to update the
                                            widget content.
                                        </p>
                                        <pre><code>&lt;Widget updateWidgetData={"{this.updateWidgetData}"} /&gt;</code></pre>
                                        <p>
                                            <strong>autoload</strong> may be set to an integer value. If set, for
                                            example, to 2000 will refresh widget every 2 seconds.
                                        </p>
                    ...
                    <span className={`icon text-white bg-${item.background}`}>
                      <i className={`fa fa-${item.icon}`}></i>
                                            ...
                                            <div className="news-item-info">
                                                <h5 className="name m-0 mb-xs"><a href="#/app/grid">{item.title}</a>
                                                </h5>
                                                <p className="fs-mini">
                                                    {item.description}
                                                </p>
