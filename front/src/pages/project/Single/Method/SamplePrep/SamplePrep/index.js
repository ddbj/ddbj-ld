...
const SamplePrepAnimal = ({match}) => {
    ...
    return (
        <Switch>
            <Route path={buildRoutePath('/method/sample_prep/sample_prep')} exact component={List}/>
            <Route path={buildRoutePath('/method/sample_prep/sample_prep/:samplePrepId')} component={Single}/>
