...
const Column = ({match}) => {
    ...
    return (
        <Switch>
            <Route
                path={buildRoutePath('/method/measurement/:measurementMethodType/:measurementMethodId/condition_nmr')}
                exact component={List}/>
            <Route
                path={buildRoutePath('/method/measurement/:measurementMethodType/:measurementMethodId/condition_nmr/:conditionNmrId')}
                component={Single}/>
