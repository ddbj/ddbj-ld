...
import {changeActiveSidebarItem, closeSidebar, openSidebar, toggleSidebar} from '../actions/navigation';
                        ...
                        <main className={classnames(s.content, sd.content)}>
                            <div className="container">
                                <div className="row">
                                    ...
                                    <Col xl={10} md={9}>
                                        <Switch>
                                            <Route path="/documentation/getting-started/overview" exact
                                                   component={Overview}/>
                                            <Route path="/documentation/getting-started/licences" exact
                                                   component={Licences}/>
                                            <Route path="/documentation/getting-started/quick-start" exact
                                            ...
                                            <Route path="/documentation/components/carousel" exact
                                                   component={Carousel}/>
                                            ...
                                            <Route path="/documentation/components/popovers" exact
                                                   component={Popovers}/>
                                            <Route path="/documentation/components/tabs-accordion" exact
                                                   component={Tabs}/>
                                            <Route path="/documentation/components/progress" exact
                                                   component={Progress}/>
