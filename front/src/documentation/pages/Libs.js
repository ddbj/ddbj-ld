            ...
            <Row className={s.root}>
                ...
                <Col lg={9}>
                    <Widget id="Animate.css">
                        <h3>Animate.css</h3>
                        <p>animate.css is a bunch of cool, fun, and cross-browser animations for you to use in your
                            projects. Great
                        ...
                        <p>For more examples please refer to <a href="https://github.com/daneden/animate.css/"
                                                                target="_blank"
                                                                rel="noopener noreferrer">Animate.css</a></p>
                    </Widget>
                    <Widget id="RC-Slider">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/react-component/slider" target="_blank"
                            rel="noopener noreferrer">rc-slider</a></p>
                    </Widget>
                    ...
                    <Widget id="Fullcalendar">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://fullcalendar.io/docs/react" target="_blank"
                            rel="noopener noreferrer">Fullcalendar</a></p>
                    </Widget>
                    ...
                    <Widget id="React-Sparkline">
                        ...
                        <p>This React.js plugin makes it easy to generate a number of different types of sparklines
                            directly in the
                            browser, using few lines of JSX.</p>
                        <Sparklines data={[13, 14, 16, 15, 4, 14, 20]}
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/borisyankov/react-sparklines" target="_blank"
                            rel="noopener noreferrer">React Sparklines</a></p>
                    </Widget>
                    ...
                    <Widget id="Rc-color-picker">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/react-component/color-picker" target="_blank"
                            rel="noopener noreferrer">Color Picker</a></p>
                    </Widget>
                    ...
                    <Widget id="React-Autosize-Textarea">
                        ...
                        <p>A light replacement for built-in <code>&lt;textarea /></code> component which automatically
                            adjusts its
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/buildo/react-autosize-textarea" target="_blank"
                            rel="noopener noreferrer">Textarea</a></p>
                    </Widget>
                    <Widget id="React-Datetime">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/YouCanBookMe/react-datetime" target="_blank"
                            rel="noopener noreferrer">DateTime</a></p>
                    </Widget>
                    <Widget id="React-dropzone">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/react-dropzone/react-dropzone" target="_blank"
                            rel="noopener noreferrer">React Dropzone</a></p>
                    </Widget>
                    <Widget id="React-Draft-Wysiwyg">
                        ...
                        <Editor/>
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/jpuri/react-draft-wysiwyg" target="_blank"
                            rel="noopener noreferrer">React Wysiwyg</a></p>
                    </Widget>
                    <Widget id="React-Google-Maps">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/tomchentw/react-google-maps" target="_blank"
                    ...
                    <Widget id="React-MDE">
                        <h3>React-mde</h3>
                        <p>A simple yet powerful and extensible Markdown Editor editor for React. React-mde is built on
                            top of
                            Draft.js.</p>
                    ...
                    <Widget id="React-Select">
                        ...
                        />
                        <p>For more examples and documentation please refer to <a href="https://react-select.com/home"
                                                                                  target="_blank"
                    ...
                    <Widget id="React-Shuffle">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/FormidableLabs/react-shuffle" target="_blank"
                            rel="noopener noreferrer">Shuffle</a></p>
                    </Widget>
                    <Widget id="React-Slick">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/FormidableLabs/react-shuffle" target="_blank"
                            rel="noopener noreferrer">React Slick</a></p>
                    </Widget>
                    <Widget id="React-Sortable">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/clauderic/react-sortable-hoc" target="_blank"
                            rel="noopener noreferrer">React Sortable</a></p>
                    </Widget>
                    <Widget id="Reactstrap">
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/clauderic/react-sortable-hoc" target="_blank"
                            rel="noopener noreferrer">Reactstrap</a></p>
                    </Widget>
                    <Widget id="Rickshaw">
                        <h3>rickshaw</h3>
                        ...
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/shutterstock/rickshaw" target="_blank"
                            rel="noopener noreferrer">Rickshaw</a></p>
                    </Widget>
                    <Widget id="Skycons">
                        <h3>Skycons</h3>
                        <p>Skycons is a set of ten animated weather glyphs, procedurally generated by JavaScript using
                            the HTML5 canvas tag.</p>
                        <Skycon icon="CLEAR_DAY" color="#17a2b8" width="40" height="40"/>
                        <p>For more examples and documentation please refer to <a
                            href="https://github.com/darkskyapp/skycons" target="_blank"
                            rel="noopener noreferrer">Skycons</a></p>
                    </Widget>
                    <Widget id="Other">
                        ...
                        <ul className="check-list">
                            <li className="lead">
                                <a className="fw-semi-bold"
                                   ...
                                   rel="noopener noreferrer" target="_blank"> @amcharts</a>.
                                JavaScript Charts & Maps Programming library for all your data visualization needs.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/ameyms/react-animated-number"
                                   rel="noopener noreferrer" target="_blank"> react-animated-number</a>.
                                A simple animated number for React.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://react-bootstrap.github.io/"
                                   rel="noopener noreferrer" target="_blank"> React Bootstrap</a>.
                                With React Bootstrap you can build responsive, mobile-first projects on the web using
                                React.js and the world's
                                most popular front-end CSS library — Bootstrap v4.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/highcharts/highcharts-react"
                                   rel="noopener noreferrer" target="_blank"> highcharts-react</a>.
                                Make your data come alive. Highcharts makes it easy for developers to set up interactive
                                charts in their web pages.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/apexcharts/react-apexcharts"
                                   rel="noopener noreferrer" target="_blank"> react-apexcharts</a>.
                                Modern & Interactive Open-source Charts.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold"
                                   href="https://github.com/frontend-collective/react-sortable-tree"
                                   rel="noopener noreferrer" target="_blank"> react-sortable-tree</a>.
                                This is a draggable tree component.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/hustcc/echarts-for-react"
                                   rel="noopener noreferrer" target="_blank"> echarts-for-react</a>.
                                A Declarative Framework for Rapid Construction of Web-based Visualization
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/olahol/react-tagsinput"
                                   rel="noopener noreferrer" target="_blank"> react-tagsinput</a>.
                                Highly customizable React component for inputing tags.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/tannerlinsley/react-table"
                                   rel="noopener noreferrer" target="_blank"> react-table</a>.
                                This React package offers an easy and intuitive way of displaying Bootstrap-styled grids
                                with data coming
                                either from the client or from the server.
                            </li>
                            <li className="lead">
                                <a className="fw-semi-bold" href="https://github.com/unsplash/react-trend"
                                   rel="noopener noreferrer" target="_blank"> react-trend</a>.
