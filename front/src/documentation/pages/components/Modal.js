    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Modal</h2>
                    <p className="mb-lg">Use Bootstrap’s JavaScript modal plugin to add dialogs to your site for
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.variatonModalsTabId}>
                        <TabPane tabId="1">
                            <h3>Variations</h3>
                            <Button className="mr-lg" onClick={() => this.toggle('scrollingLong')} size="lg"
                                    color="danger">Long modal</Button>
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/modal/"
                                                         target="_blank" rel="noopener noreferrer">Reactstrap Modal</a>
                </Col>
