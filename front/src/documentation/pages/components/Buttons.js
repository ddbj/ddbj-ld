...
import {Breadcrumb, BreadcrumbItem, Button, Col, Nav, NavItem, NavLink, Row, TabContent, TabPane} from 'reactstrap';
    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Buttons</h2>
                    <p className="mb-lg">Bootstrap includes several predefined button styles, each serving its own
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.defaultButtonTabId}>
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript'
                                               style={tomorrow}>{'<Button color="default" className="width-100 mb-xs mr-xs">Default</Button>\n' +
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.outlineButtonsTabId}>
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript' style={tomorrow}>
                                ...
                                '<Button outline color="info">Summary</Button>\n' +
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/buttons/"
