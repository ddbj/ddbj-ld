...
import {Alert, Breadcrumb, BreadcrumbItem, Col, Nav, NavItem, NavLink, Row, TabContent, TabPane} from 'reactstrap';
...
class Overview extends Component {
    state = {
        ...
        alertsOne: [{
            ...
            id: 'al-2',
            type: 'info',
            msg: '<span class="fw-semi-bold">Summary:</span> This alert needs your attention, but it\'s not super important.',
            visible: true,
        }, {
            id: 'al-3',
            type: 'warning',
    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Alerts</h2>
                    <p className="mb-lg">Provide contextual feedback messages for typical user actions with the handful
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/alerts/"
                                                         target="_blank" rel="noopener noreferrer">Reactstrap Alerts</a>
                </Col>
            </Row>
        );
    }
