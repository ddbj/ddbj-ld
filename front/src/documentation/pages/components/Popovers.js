    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Popovers</h2>
                    <p className="mb-lg">The Popover is similar to Tooltip; it is a pop-up box that appears when the
                        user clicks on an element. The difference is that the popover can contain much more content.</p>
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.defaultPopoversTabId}>
                        <TabPane tabId="1">
                            <Button className="mr" id="popover-1" type="button" color="success"
                                    onClick={() => this.toggle(1)}>
                                Bottom
                            </Button>
                            <Button className="mr" id="popover-2" type="button" color="danger"
                                    onClick={() => this.toggle(2)}>
                                Right
                            </Button>
                            <Button className="mr" id="popover-3" type="button" color="warning"
                                    onClick={() => this.toggle(3)}>
                                Top
                            </Button>
                            <Button className="mr" id="popover-4" type="button" color="info"
                                    onClick={() => this.toggle(4)}>
                                Left
                            </Button>
                            <Popover placement="bottom" isOpen={this.state.popovers[1]} target="popover-1"
                            ...
                            <Popover placement="right" isOpen={this.state.popovers[2]} target="popover-2"
                                     toggle={() => this.toggle(2)}>
                                <PopoverHeader>Popover Title</PopoverHeader>
                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque
                                    ornare sem lacinia quam venenatis vestibulum.</PopoverBody>
                            </Popover>
                            <Popover placement="top" isOpen={this.state.popovers[3]} target="popover-3"
                                     toggle={() => this.toggle(3)}>
                                <PopoverHeader>Popover Title</PopoverHeader>
                                <PopoverBody>Sed posuere consectetur est at lobortis. Aenean eu leo quam. Pellentesque
                                    ornare sem lacinia quam venenatis vestibulum.</PopoverBody>
                            </Popover>
                            <Popover placement="left" isOpen={this.state.popovers[4]} target="popover-4"
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript'
                                               style={tomorrow}>{'<Button id="popover" type="button" color="info" onClick={this.toggle}>\n' +
                            '  Top\n' +
                            '</Button>\n\n' +
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.defaultTooltipsTabId}>
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript'
                                               style={tomorrow}>{'<Button className="mr" id="tooltip" type="button" color="info">\n' +
                            '  Left\n' +
                            '</Button>\n\n' +
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/popovers/"
                                                         target="_blank" rel="noopener noreferrer">Reactstrap
                    Popovers</a>
                    &nbsp;and <a href="https://reactstrap.github.io/components/tooltips/" target="_blank"
                                 rel="noopener noreferrer">Reactstrap Tooltips</a>
                </Col>
            </Row>
        );
    }
