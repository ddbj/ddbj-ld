...
import {Breadcrumb, BreadcrumbItem, Col, Collapse, Nav, NavItem, NavLink, Row, TabContent, TabPane} from 'reactstrap';
            ...
            <Row>
                ...
                <Col lg={9}>
                    ...
                    <SyntaxHighlighter language='javascript'
                                       style={tomorrow}>{'<TabContent className="mb-xlg" activeTab={this.state.activeTabId}>\n' +
                    '  <TabPane tabId="1">\n' +
                    '    First tab content\n' +
                    '  </TabPane>\n' +
                    '  <TabPane tabId="2">\n' +
                    ...
                    <div className="card panel mt-lg mb-xs">
                        ...
                        <Collapse className="panel-body" isOpen={this.state.accordion[0]}>
                            <p>Get base styles and flexible support for collapsible components like accordions and
                                navigation.
                    ...
                    <div className="card panel mb-xs">
                        ...
                        <Collapse className="panel-body" isOpen={this.state.accordion[1]}>
                            <p>Why don't use Lore Ipsum? I think if some one says don't use lore ipsum it's very
                                controversial point. I think the opposite actually.
                            </p>
                        </Collapse>
                    </div>
                    <div className="card panel mb-lg">
                        ...
                        <Collapse className="panel-body" isOpen={this.state.accordion[2]}>
                            <p><span className="fw-semi-bold">Light Blue</span> - is a next generation admin template
                                based
                                on the latest Metro design. There are few reasons we want to tell you, why we have
                                created it:
                                We didn't like the darkness of most of admin templates, so we created this light one.
                                We didn't like the high contrast of most of admin templates, so we created this
                                unobtrusive one.
                                We searched for a solution of how to make widgets look like real widgets, so we decided
                                that
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/collapse/"
