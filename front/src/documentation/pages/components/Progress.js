...
import {Breadcrumb, BreadcrumbItem, Col, Nav, NavItem, NavLink, Progress, Row, TabContent, TabPane} from 'reactstrap';
    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Progress</h2>
                    <p className="mb-lg">Cards support a wide variety of content, including images, text, list groups,
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.defaultProgressTabId}>
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript'
                                               style={tomorrow}>{'<div className="text-center">0%</div>\n' +
                            '<Progress />\n' +
                            '<div className="text-center">25%</div>\n' +
                            '<Progress value="25" />\n' +
                            '<div className="text-center">50%</div>\n' +
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/progress/"
