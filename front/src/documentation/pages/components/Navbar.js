    ...
    render() {
        return (
            <Row>
                ...
                <Col lg={9}>
                    <h2>Navbar</h2>
                    <p className="mb-lg">Documentation and examples for Bootstrap’s powerful, responsive navigation
                        header, the navbar.
                        Includes support for branding, navigation, and more, including support for our collapse
                        plugin.</p>
                    ...
                    <TabContent className="mb-xlg" activeTab={this.state.defaultNavTabId}>
                        ...
                        <TabPane tabId="2">
                            <SyntaxHighlighter language='javascript'
                                               style={tomorrow}>{'<Navbar color="light" light expand="md">\n' +
                            '  <NavbarBrand href="/">Sing</NavbarBrand>\n' +
                            '  <NavbarToggler />\n' +
                            '  <Collapse navbar>\n' +
                            '    <Nav className="ml-auto" navbar>\n' +
                    ...
                    For more examples please refer to <a href="https://reactstrap.github.io/components/card/"
                                                         target="_blank" rel="noopener noreferrer">Reactstrap Card</a>
                </Col>
            </Row>
        );
    }
