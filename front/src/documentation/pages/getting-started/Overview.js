    ...
    <Row>
        ...
        <Col lg={9}>
            <Widget id="Overview">
                <h1>Overview</h1>
                <p className="lead">
                    Sing App React is an admin dashboard template built with React 16.5.2. Sing App goes beyond usual
                    admin
                    templates and provides you entire intuitive programming framework. Server Side Rendering and Node.js
                    backend
                    will even further speed up your development. You can use Sing App React to build any type of web
                    applications
                ...
                <p className="lead">
                    Moreover, there is a version of <a rel="noreferrer noopener"
                                                       ...
                                                       target="_blank">Sing App React with Node.js</a>, enhanced with
                    working node.js
            ...
            <Widget id="Features">
                ...
                <ul className="mt">
                    ...
                    <li className="lead"><i className="la la-check"/>
                        <a href="https://github.com/flatlogic/nodejs-backend" rel="noopener noreferrer"
                           target="_blank"> Node.js backend support</a> <span className="small text-muted">(Only in full stack version)</span>
                    </li>
