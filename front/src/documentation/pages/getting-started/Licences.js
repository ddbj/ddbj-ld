...
import {Breadcrumb, BreadcrumbItem, Col, Row, Table} from 'reactstrap';
    ...
    <Row>
        ...
        <Col lg={9}>
            ...
            <p class="mt">
                ...
                to contact us via email: <a class="text-warning"
                                            href="mailto:support@flatlogic.com">support@flatlogic.com</a>.
            </p>
        </Col>
        <Col lg={3}>
            <Scrollspy
