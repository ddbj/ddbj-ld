        ...
        return (
          ...
          <span className={[s.notificationIcon, 'thumb-sm'].join(' ')}>
            ...
            <i className="status status-bottom bg-success"/>
                    ...
                    <p className="deemphasize text-ellipsis m-0">Good news coming tonight. Seems they agreed to
                        proceed</p>
                </ListGroupItem>
                <ListGroupItem className={s.listGroupItem}>
          <span className={[s.notificationIcon, 'thumb-sm'].join(' ')}>
          ...
          <span className={[s.notificationIcon, 'thumb-sm'].join(' ')}>
            ...
            <i className="status status-bottom bg-gray-light"/>
                    ...
                    <p className="deemphasize text-ellipsis m-0">Just ain&apos;t sure about the weekend now. 90%
                        I&apos;ll make it.</p>
                </ListGroupItem>
                <ListGroupItem className={s.listGroupItem}>
          <span className={[s.notificationIcon, 'thumb-sm'].join(' ')}>
            ...
            <i className="status status-bottom bg-success"/>
                    ...
                    <p className="deemphasize text-ellipsis m-0">Hey what&apos;s up? Me and Monica going for a lunch
                        somewhere. Wanna join?</p>
                </ListGroupItem>
            </ListGroup>
        );
    }
