        ...
        if (!this.props.childrenLinks) {
            if (this.props.isHeader) {
              ...
              <span className={classnames('icon', s.icon)}>
                <i className={`fi ${this.props.iconName}`}/>
                            ...
                            {this.props.header} {this.props.label && <sup
                            className={`${s.headerLabel} ${s.headerUpdate} text-${this.props.labelColor || 'warning'}`}>{this.props.label}</sup>}
            ...
            return (
                <li>
                    ...
                    >
                        {this.props.header} {this.props.label && <sup
                        className={`${s.headerLabel} text-${this.props.labelColor || 'warning'}`}>{this.props.label}</sup>}
                    </NavLink>
                </li>
            );
        }
            ...
            <Route
                ...
                children={(params) => {
                    ...
                    <i className={`fi ${this.props.iconName}`}/>
                                ...
                                {this.props.header} {this.props.label && <sup
                                className={`${s.headerLabel} ${s.headerNode} ml-1 text-${this.props.labelColor || 'warning'}`}>{this.props.label}</sup>}
